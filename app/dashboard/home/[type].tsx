    ...
    transactions: [
      {
        ...
        category: "Pending",
        image:
          "https://uxwing.com/wp-content/themes/uxwing/download/brands-and-social-media/walmart-icon.png",
      },
      {
        id: "2",
        title: "NIKE STORE",
        ...
        category: "Shopping",
        image:
          "https://i.pinimg.com/originals/5b/99/13/5b99139887bc830277b522d35dc863ae.jpg",
      },
    ],
  },
  {
    ...
    transactions: [
      {
        ...
        image:
          "https://w7.pngwing.com/pngs/1001/70/png-transparent-computer-icons-natural-gas-industrial-gas-industry-miscellaneous-text-trademark.png",
      },
    ],
  },
];
              ...
              <TouchableOpacity style={styles.flatListContainer} key={i}>
                ...
                >
                  ...
                  <View>
                    ...
                    <Text style={styles.flatListSubText}>
                      {transaction.category}
                    </Text>
                  </View>
                </View>

                <Text style={styles.flatLIstAmount}>
